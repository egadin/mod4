...
inc_mutex(void *arg __attribute__((unused)))
{
    ...
    for (i = 0; i < INC_ITERATIONS; i++) {
        ...
        counter += INCREMENT;  //tre separata commandon ladda öka spara och efter en laddning så kan andra proccessen minska det som vi redan har laddat innan vi laddar om den igen vilket resulterar i fel värde på vår counter.
